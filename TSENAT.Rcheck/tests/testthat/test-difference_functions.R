...
test_that("Label shuffling test is correct", {
    ...
    expect_true(is.numeric(as.numeric(shuffling_result[1, 1])) && as.numeric(shuffling_result[1, 1]) >= 0 && as.numeric(shuffling_result[1, 1]) <= 1)
    expect_true(is.numeric(as.numeric(shuffling_result[1, 2])) && as.numeric(shuffling_result[1, 2]) >= 0 && as.numeric(shuffling_result[1, 2]) <= 1)
})
