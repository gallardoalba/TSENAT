...
values $q < 1$ emphasize low-abundance (rare) isoforms and therefore capture 
richness, while values $q > 1$ emphasize high-abundance (dominant) isoforms 
and therefore capture dominance. 
