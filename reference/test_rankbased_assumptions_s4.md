...
`TSENATAnalysis` object with stored assumption test results.
...
by evaluating exchangeability, monotonicity, and consistency
assumptions.

This wrapper calls `.test_rankbased_assumptions()` on diversity data
