...
This page contains all references cited in the TSENAT package, organized by topic. For a complete list in BibTeX format, see the [vignettes/TSENAT.bib](https://github.com/gallardoalba/TSENAT/blob/stable/vignettes/TSENAT.bib) file.
