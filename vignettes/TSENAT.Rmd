...
The last pre-processing step is the creation of a `SummarizedExperiment`
data container. A `SummarizedExperiment` is a standard Bioconductor class
for storing high-throughput assay data along with associated metadata.
