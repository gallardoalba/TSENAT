...
# compute Tsallis entropy for a single q value (unnormalized)
q <- 0.1
ts_se <- calculate_diversity(se, q = q, norm = FALSE)
...
# compute Tsallis entropy for q = 1 (unnormalized, for robust visualization)
q <- c(0.1, 2)
...
# compute Tsallis entropy for a sequence of values (unnormalized)
