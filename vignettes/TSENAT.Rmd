...
are often skewed and sensitive to outliers, and the median provides in
this condition a more robust summary of central tendency than the mean.
...
most significant genes identified in the previous step. In that
case we will use the median as the aggregation metric, which 
will allow us to see the most consistent isoform-expression 
