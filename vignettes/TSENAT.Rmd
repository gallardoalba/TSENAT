...
## Load required files with fallbacks so vignette builds under CI and locally
coldata_tsv <- system.file("extdata", "coldata.tsv", package = "TSENAT")
tx2gene_tsv <- system.file("extdata", "tx2gene.tsv", package = "TSENAT")

# fallback to package source `inst/extdata/` when system.file fails
...
# Ensure example dataset is available in the vignette environment
\[
...
coldata_tsv <- system.file("extdata", "coldata.tsv", package = "TSENAT")
tx2gene_tsv <- system.file("extdata", "tx2gene.tsv", package = "TSENAT")
load("data/tcga_brca_luma_dataset.RData", envir = globalenv())
