...
if (!is.null(sample_data) && nrow(sample_data) > 0) {
    ...
    kableExtra::scroll_box(
      width = "100%",
      height = "auto",
      extra_css = "overflow-x: auto; overflow-y: hidden; border: 1px solid #ddd; padding: 10px;"
    ))
} else {
...
if (!is.null(sample_qc) && nrow(sample_qc) > 0) {
  ...
  kableExtra::scroll_box(width = "100%", height = "auto", extra_css = "overflow-x: auto; overflow-y: hidden; border: 1px solid #ddd; padding: 10px;")
}
```
