...
display_cols <- c(
    ...
    "per_q_pattern", "div_rare_median", "div_abundant_median"
)
...
col_names <- c(
    ...
    "Pattern", "Rare Median", "Abundant Median"
)
...
The effect sizes reveal which genes show the most information-theoretic separation across the q-spectrum between paired treatment groups. Genes with Tsallis divergence D > 0.1 show substantial divergence, indicating fundamental differences in entropy distributions between conditions.
