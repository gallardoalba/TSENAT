...
if (!is.null(concordance_results) && is.list(concordance_results)) {
  ...
  if (!is.null(concordance_results$agreement_dist) && nrow(concordance_results$agreement_dist) > 0) {
    ...
    print(knitr::kable(concordance_results$agreement_dist, 
                 caption = "**Supplementary Table 20 | Agreement Distribution: Concordance by Gene Category.** Distribution of genes across categories: both methods significant, GAM only, Conover-Iman Rank Transform only, and neither method.",
                 align = c("l", "r", "r")))
  }
  ...
  if (!is.null(concordance_results$high_conf_table) && nrow(concordance_results$high_conf_table) > 0) {
    ...
    print(knitr::kable(concordance_results$high_conf_table, 
                 caption = paste0("**Supplementary Table 21 | Robust Entropic Order Index Interactions: High-Confidence Genes Detected by Both Methods (n=", n_hc, ", ranked by statistical significance).** Cross-method validation: genes significant in both GAM and Conover-Iman Rank Transform provide strongest evidence for q × condition effects."),
                 align = c("l", "r", "r", "r", "r")))
  }
} else {
