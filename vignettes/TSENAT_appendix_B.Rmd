...
```{css, echo=FALSE}
/* Fix table rendering in scroll containers */
...
div[style*="overflow-x: scroll"] thead th {
  position: sticky;
  top: 0;
...
knitr::kable(summary_stats, caption = "GAM Results Summary", label = "tab:gam-summary-stats", align = c("l", "r"), format = if (knitr::is_latex_output()) "latex" else "html")
  kableExtra::kable_styling(
    bootstrap_options = c("striped", "hover", "responsive"),
    full_width = TRUE,
    latex_options = c()
