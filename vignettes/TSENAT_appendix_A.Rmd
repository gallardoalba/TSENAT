...
# Create sample group classification
sample_group <- ifelse(grepl("_N$", colnames(shannon_entropy)), "Normal", "Tumor")

# Add metadata to SplicingFactory objects
colData(shannon_entropy)$sample_type <- sample_group
colData(simpson_index)$sample_type <- sample_group

# Add metadata to TSENAT objects
colData(tsenat_q1_values)$group <- sample_group
colData(tsenat_q2_values)$group <- sample_group
...
shannon_tsenat <- TSENAT::plot_volcano_ma_grid(
...
simpson_tsenat <- TSENAT::plot_volcano_ma_grid(
