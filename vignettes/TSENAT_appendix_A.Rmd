...
# Add sample_type metadata to SplicingFactory objects (matches their naming)
...
# TSENAT: Differential analysis for Tsallis q=1 - using S4 wrapper
# The "group" metadata is already available in colData from diversity calculations
...
# TSENAT: Differential analysis for Tsallis q=2 - using S4 wrapper
