...
tsenat_shannon_diff <- results(tsenat_analysis_q1, type = "pairwise")

# Extract diversity results using results accessor for q=1
tsenat_q1_diversity <- results(tsenat_analysis_q1, type = "diversity", q = 1.0)
cat("TSENAT Diversity Results (q=1):\n")
print(head(tsenat_q1_diversity, n = 10))
...
# Extract results for downstream functions
tsenat_simpson_diff <- results(tsenat_analysis_q2, type = "pairwise")

# Extract diversity results using results accessor for q=2
tsenat_q2_diversity <- results(tsenat_analysis_q2, type = "diversity", q = 2.0)
cat("TSENAT Diversity Results (q=2):\n")
print(head(tsenat_q2_diversity, n = 10))
```
...
shannon_summary <- TSENAT:::.create_summary_stats(
...
shannon_tsenat <- plot_diversity_volcano_ma_s4(
  analysis = tsenat_analysis_q1,
  x_col = "mean_difference",
  padj_col = "padj",
  sig_alpha = 0.05,
...
# Summary statistics using helper function
simpson_summary <- TSENAT:::.create_summary_stats(
...
# TSENAT S4 wrapper method
simpson_tsenat <- plot_diversity_volcano_ma_s4(
  analysis = tsenat_analysis_q2,
  x_col = "mean_difference",
  padj_col = "padj",
  sig_alpha = 0.05,
