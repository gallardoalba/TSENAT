...
# TSENAT: Skipping differential analysis (calculate_difference was removed from v1.0)
# To perform differential analysis, use calculate_rank_test() instead for Q×Condition interaction testing

tsenat_shannon_diff <- NA  # Placeholder - differential analysis not available
...
# calculate_difference was removed from v1.0
# Use calculate_rank_test() instead for rank-based analysis
