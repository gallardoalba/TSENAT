...
knitr::kable(shannon_summary, caption = "Shannon Entropy Analysis Summary Statistics", align = c("l", "r", "r", "r", "r", "r", "r"), format = if (knitr::is_latex_output()) "latex" else "html", longtable = knitr::is_latex_output(), linesep = "") %>%
...
knitr::kable(shannon_sf_top, row.names = FALSE, caption = "SplicingFactory (Laplace) - Top 10 Significant Genes", align = c("l", "r", "r", "r", "r", "r", "r"), format = if (knitr::is_latex_output()) "latex" else "html", longtable = knitr::is_latex_output(), linesep = "") %>%
kableExtra::kable_styling(bootstrap_options = c("striped", "hover", "condensed"), latex_options = c("scale_down"))
```
...
knitr::kable(shannon_tsenat_top, row.names = FALSE, caption = "TSENAT (Tsallis q=1) - Top 10 Significant Genes", align = c("l", "r", "r", "r", "r", "r", "r"), format = if (knitr::is_latex_output()) "latex" else "html", longtable = knitr::is_latex_output(), linesep = "") %>%
kableExtra::kable_styling(bootstrap_options = c("striped", "hover", "condensed"), latex_options = c("scale_down"))
```

```{r comparison_volcano_ma_plots, fig.width=14, fig.height=7, message=FALSE, warning=FALSE, out.width="98%", fig.pos="H", fig.cap="Volcano and MA plots comparing Shannon entropy (q=1) equivalence between TSENAT and SplicingFactory. Volcano plots (left) show log-fold change on X-axis and -log10(p-value) on Y-axis, with significant genes highlighted. MA plots (right) display log-average abundance versus log-fold change. Each row compares one method to the other (top: SplicingFactory method, bottom: TSENAT method). Diagonal concordance indicates equivalent statistical testing and effect size estimation between packages."}
...
knitr::kable(simpson_summary, caption = "Simpson Index Analysis Summary Statistics", align = c("l", "r", "r", "r", "r", "r", "r"), format = if (knitr::is_latex_output()) "latex" else "html", longtable = knitr::is_latex_output(), linesep = "") %>%
...
knitr::kable(simpson_sf_top, row.names = FALSE, caption = "SplicingFactory (Simpson) - Top 10 Significant Genes", align = c("l", "r", "r", "r", "r", "r", "r"), format = if (knitr::is_latex_output()) "latex" else "html", longtable = knitr::is_latex_output(), linesep = "") %>%
kableExtra::kable_styling(
  bootstrap_options = c("striped", "hover", "condensed"),
  latex_options = c("scale_down")
)
...
knitr::kable(simpson_tsenat_top, row.names = FALSE, caption = "TSENAT (Tsallis q=2) - Top 10 Significant Genes", align = c("l", "r", "r", "r", "r", "r", "r"), format = if (knitr::is_latex_output()) "latex" else "html", longtable = knitr::is_latex_output(), linesep = "") %>%
kableExtra::kable_styling(
  bootstrap_options = c("striped", "hover", "condensed"),
  latex_options = c("scale_down")
)
...
```{r comparison_ma_plots, fig.width=14, fig.height=7, message=FALSE, warning=FALSE, out.width="98%", fig.pos="H", fig.cap="Volcano and MA plots comparing Simpson index (q=2) equivalence between TSENAT and SplicingFactory. These plots validate that TSENAT's Tsallis entropy at q=2 produces statistically identical results to SplicingFactory's Simpson index implementation. Volcano plots show significance thresholds; MA plots reveal how effect sizes scale with average abundance. Overlapping point clouds and identical significance calls demonstrate mathematical equivalence."}
