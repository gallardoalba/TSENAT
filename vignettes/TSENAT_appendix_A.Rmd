...
tsenat_analysis_q1@config$condition_col <- "group"
tsenat_analysis_q2@config$condition_col <- "group"
...
tsenat_shannon_diff <- tsenat_analysis_q1@lm_results$difference
...
# Extract results for downstream functions
tsenat_simpson_diff <- tsenat_analysis_q2@lm_results$difference
```
