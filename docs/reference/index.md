...
- [`calculate_fc_readcounts()`](https://gallardoalba.github.io/TSENAT/reference/calculate_fc_readcounts.md)
...
- [`.compute_transcript_fill_limits()`](https://gallardoalba.github.io/TSENAT/reference/dot-compute_transcript_fill_limits.md)
  : Helper to compute fill limits across multiple genes
- [`.draw_transcript_grid()`](https://gallardoalba.github.io/TSENAT/reference/dot-draw_transcript_grid.md)
  : Helper to draw grid layout with title, plots, and legend using base
  grid
- [`extract_top_genes()`](https://gallardoalba.github.io/TSENAT/reference/extract_top_genes.md)
  : Extract significant genes and prepare plotting data
- [`filter_lowly_expressed()`](https://gallardoalba.github.io/TSENAT/reference/filter_lowly_expressed.md)
...
- [`plot_ma_lm_interaction()`](https://gallardoalba.github.io/TSENAT/reference/plot_lm_interaction.md)
  [`plot_volcano_lm_interaction()`](https://gallardoalba.github.io/TSENAT/reference/plot_lm_interaction.md)
...
- [`prepare_diff_df()`](https://gallardoalba.github.io/TSENAT/reference/prepare_diff_df.md)
