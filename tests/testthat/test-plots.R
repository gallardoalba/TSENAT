...
# is not adequate for Tsallis multi-q analysis (violates AR(1) dependency structure).
# Use calculate_lm_interaction() with AR(1)-aware methods instead (lmm, fpca, gam, gee).
