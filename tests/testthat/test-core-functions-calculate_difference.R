...
# =====================================================================
# NOTE (March 2026): use_ci_weighting feature completely removed
# See: CI_WEIGHTING_VALIDATION_REPORT.txt, BY020 (Kotzen), BY021 (Kleijn), S232 (Bayarri & Berger)
# Bayesian CI weighting violates frequentist principles and lacks peer-reviewed support
# ===================================================================== 

# =====================================================================
# NOTE (March 2026): Both remaining Bayesian features removed
# - use_hierarchical_prior (Bayesian AR(1) prior)
# - combined use_ci_weighting + use_hierarchical_prior
# See CI_WEIGHTING_VALIDATION_REPORT.txt for justification
# ===================================================================== 
