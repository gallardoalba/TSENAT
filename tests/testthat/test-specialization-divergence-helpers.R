...
# =====================================================================
# Tests for .tsenat_jis_resample_paired_data
# =====================================================================

test_that(".tsenat_jis_resample_paired_data resamples paired structure correctly", {
  ...
  set.seed(123)
  result <- TSENAT:::.tsenat_jis_resample_paired_data(
    control_samples,
    treatment_samples,
    pair_ids,
    group_col,
...
test_that(".tsenat_jis_resample_paired_data maintains pair membership", {
...
test_that(".tsenat_jis_resample_paired_data throws error for unequal groups", {
...
# =====================================================================
# Tests for .tsenat_classify_q_pattern
# =====================================================================

test_that(".tsenat_classify_q_pattern identifies RARE_DRIVEN pattern", {
  ...
  result <- TSENAT:::.tsenat_classify_q_pattern(per_q_divs, ratio_threshold = 1.3)
  
  expect_equal(result, "RARE_DRIVEN")
})

test_that(".tsenat_classify_q_pattern identifies ABUNDANT_DRIVEN pattern", {
...
test_that(".tsenat_classify_q_pattern identifies BALANCED pattern", {
...
test_that(".tsenat_classify_q_pattern returns NA for empty input", {
  ...
  result <- TSENAT:::.tsenat_classify_q_pattern(per_q_divs)
  
  expect_true(is.na(result))
})

test_that(".tsenat_classify_q_pattern returns NA for all NAs", {
...
test_that(".tsenat_classify_q_pattern handles mixed NA values", {
...
test_that(".tsenat_classify_q_pattern respects ratio_threshold", {
  per_q_divs <- c(
    "q_0.01" = 0.6,
    "q_0.5" = 0.65,
    "q_1.0" = 0.5,
  ...
  result_low <- TSENAT:::.tsenat_classify_q_pattern(per_q_divs, ratio_threshold = 1.05)
  result_high <- TSENAT:::.tsenat_classify_q_pattern(per_q_divs, ratio_threshold = 2.0)
...
# =====================================================================
# Tests for .tsenat_tsallis_divergence_scalar
# =====================================================================

test_that(".tsenat_tsallis_divergence_scalar computes q=1 edge case", {
  # q=1 is Shannon entropy, handled specially
  x <- c(0.2, 0.3, 0.5)
  y <- c(0.1, 0.4, 0.5)
  
  result <- TSENAT:::.tsenat_tsallis_divergence_scalar(x, y, q_val = 1.0)
...
test_that(".tsenat_tsallis_divergence_scalar computes positive divergence", {
  x <- c(0.5, 0.5)
  y <- c(1.0, 0.0)
  
  result <- TSENAT:::.tsenat_tsallis_divergence_scalar(x, y, q_val = 2.0)
  
  expect_type(result, "double")
  expect_true(result > 0)
})

test_that(".tsenat_tsallis_divergence_scalar handles q=0 correctly", {
  x <- c(0.33, 0.33, 0.34)
  y <- c(0.5, 0.5, 0.0)
  
  result <- TSENAT:::.tsenat_tsallis_divergence_scalar(x, y, q_val = 0.5)
  
  expect_type(result, "double")
  expect_true(is.finite(result))
})

test_that(".tsenat_tsallis_divergence_scalar returns 0 for identical distributions", {
  x <- c(0.2, 0.3, 0.5)
  
  result <- TSENAT:::.tsenat_tsallis_divergence_scalar(x, x, q_val = 1.5)
...
# =====================================================================
# Additional Tests for .tsenat_classify_q_pattern (edge cases)
# =====================================================================

test_that(".tsenat_classify_q_pattern rejects non-numeric input", {
...
test_that(".tsenat_classify_q_pattern rejects input with length < 2", {
...
test_that(".tsenat_classify_q_pattern rejects NA names", {
...
test_that(".tsenat_classify_q_pattern extracts q values from names", {
...
test_that(".tsenat_classify_q_pattern handles alternative name format q_0_5", {
...
test_that(".tsenat_classify_q_pattern rejects unparseable q names", {
...
test_that(".tsenat_classify_q_pattern has only rare-region values", {
...
test_that(".tsenat_classify_q_pattern has only abundant-region values", {
...
test_that(".tsenat_classify_q_pattern handles zero divergence in abundant region", {
...
test_that(".tsenat_classify_q_pattern classifies RARE_DRIVEN correctly", {
...
test_that(".tsenat_classify_q_pattern classifies ABUNDANT_DRIVEN correctly", {
...
test_that(".tsenat_classify_q_pattern classifies BALANCED correctly", {
...
test_that(".tsenat_classify_q_pattern returns NA when no valid divergence data", {
...
test_that(".tsenat_classify_q_pattern handles single valid pair in each region", {
